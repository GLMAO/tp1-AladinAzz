...
public class DummyTimeServiceImpl
    ...
    int secondes;
    int heures;
    final PropertyChangeSupport listeners ;
    ...
    private void dixiemeDeSecondesChanged(int oldValue, int newValue) {
       listeners.firePropertyChange(TimerChangeListener.DIXEME_DE_SECONDE_PROP,oldValue,dixiemeDeSeconde);
    }
    ...
    private void minutesChanged(int oldValue, int minutes) {
        listeners.firePropertyChange(TimerChangeListener.MINUTE_PROP,oldValue, minutes);
    }
    ...
    private void heuresChanged(int oldValue, int heures) {
        listeners.firePropertyChange(TimerChangeListener.HEURE_PROP,oldValue, heures);
    }
